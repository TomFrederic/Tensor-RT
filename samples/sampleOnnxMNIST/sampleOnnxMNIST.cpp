...
void onnxToGIEModel( const std::string& modelFile,        // name of the onnx model 
...
{
    // create a GIE model from the onnx model and serialize it to a stream
    IHostMemory *gieModelStream{nullptr};
    onnxToGIEModel("mnist.onnx", 1, gieModelStream);
