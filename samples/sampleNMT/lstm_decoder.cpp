...
namespace nmtSample
{
        ...
        nvinfer1::ITensor ** outputStates)
    {
        ...
        nvinfer1::ITensor * shuffledHiddenState;
        {
            ...
            assert(shuffleLayer != nullptr);
            nvinfer1::Dims shuffleDims{3, {beamWidth, mNumLayers, mNumUnits}, {nvinfer1::DimensionType::kINDEX, nvinfer1::DimensionType::kSPATIAL, nvinfer1::DimensionType::kCHANNEL}};
            shuffleLayer->setReshapeDimensions(shuffleDims);
        ...
        decoderLayer->setHiddenState(*shuffledHiddenState);
        decoderLayer->setCellState(*shuffledCellState);
        *outputData = decoderLayer->getOutput(0);
        ...
        {
            auto shuffleLayer = network->addShuffle(*outputStates[0]);
            assert(shuffleLayer != nullptr);
            nvinfer1::Dims shuffleDims{2, {beamWidth, mNumUnits * mNumLayers}, {nvinfer1::DimensionType::kINDEX, nvinfer1::DimensionType::kCHANNEL}};
            shuffleLayer->setReshapeDimensions(shuffleDims);
            auto shuffledOutput = shuffleLayer->getOutput(0);
            assert(shuffledOutput != nullptr);
            outputStates[0] = shuffledOutput;
        }
        ...
        {
            auto shuffleLayer = network->addShuffle(*outputStates[1]);
            assert(shuffleLayer != nullptr);
            nvinfer1::Dims shuffleDims{2, {beamWidth, mNumUnits * mNumLayers}, {nvinfer1::DimensionType::kINDEX, nvinfer1::DimensionType::kCHANNEL}};
            shuffleLayer->setReshapeDimensions(shuffleDims);
            auto shuffledOutput = shuffleLayer->getOutput(0);
            assert(shuffledOutput != nullptr);
            outputStates[1] = shuffledOutput;
        }
    }

    std::vector<int> LSTMDecoder::getStateSizes()
    {
